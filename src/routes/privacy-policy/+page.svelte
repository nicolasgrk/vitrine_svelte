        ...
        <div class="col-md-8">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="pillOne" role="tabpanel">
              ...
              <p>Nous collectons les informations suivantes via notre formulaire sur le site :</p>
                <ul>
                  <li>Nom</li>
                  <li>Prénom</li>
            ...
            <div class="tab-pane fade" id="pillTwo" role="tabpanel">
              ...
              <ul>
                <li>Contacter l'utilisateur en réponse à sa demande d'informations ou de services.</li>
            ...
            <div class="tab-pane fade" id="pillThree" role="tabpanel">
              ...
              <p>
                NicolasGurak conservera vos informations personnelles seulement pour la durée nécessaire aux fins établies dans cette Politique de Confidentialité. Nous conserverons et utiliserons vos informations 
                dans la mesure nécessaire pour nous conformer à nos obligations légales, résoudre des litiges et appliquer nos politiques.
              </p>
            </div>
            <div class="tab-pane fade" id="pillFour" role="tabpanel">
              <h3>Sécurité de l’Information</h3>
              <p>
                La sécurité de vos données personnelles est importante pour nous, mais rappelez-vous qu'aucune méthode de transmission sur Internet ou méthode de stockage électronique n'est sécurisée à 100 %. Bien que nous nous efforcions d'utiliser 
