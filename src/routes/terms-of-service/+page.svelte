        ...
        <div class="col-md-8">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="pillOne" role="tabpanel">
              ...
              <p>
                Le contenu de ce site est destiné à fournir des informations sur les services offerts par NicolasGurak. 
                Le site est conçu pour un usage personnel et non commercial. 
                Toute utilisation du contenu de ce site à des fins commerciales sans notre consentement écrit préalable est strictement interdite.
              </p>
            </div>
            <div class="tab-pane fade" id="pillTwo" role="tabpanel">
              <h3>Propriété Intellectuelle</h3>
              <p>
                Tous les contenus présents sur ce site, y compris, sans limitation, les textes, graphiques, logos, images, et la compilation de ces éléments, sont la propriété de NicolasGurak ou de ses fournisseurs de contenu
                 et sont protégés par les lois sur la propriété intellectuelle. 
                L'utilisation non autorisée du contenu peut violer ces lois.
              </p>
            </div>
            <div class="tab-pane fade" id="pillThree" role="tabpanel">
              <h3>Limitation de Responsabilité</h3>
              <p>
                NicolasGurak ne sera pas responsable des dommages de toute nature découlant de l'utilisation de ce site, 7
            ...
            <div class="tab-pane fade" id="pillFour" role="tabpanel">
              ...
              <p>
                Bien que nous nous efforcions d'assurer l'exactitude et la mise à jour des informations sur notre site, des erreurs ou des omissions peuvent survenir. 
                Nous ne garantissons pas l'exactitude, la fiabilité ou l'exhaustivité des informations présentées sur notre site.
              </p>
            </div>
            <div class="tab-pane fade" id="pillFive" role="tabpanel">
              <h3>Modifications des Conditions</h3>
              <p>
                NicolasGurak se réserve le droit de modifier ou de remplacer ces conditions à tout moment. Il est de votre responsabilité de vérifier périodiquement ces conditions pour tout changement.
              </p>
            </div>
          </div>
        </div>
